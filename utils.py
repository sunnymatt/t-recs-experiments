...
def create_profiles(
    ...
    if total_users is not None:
        ...
        user_profiles = np.random.uniform(size=(total_users, num_attrs))
        ...
        if separate_attr: # each group gets its own attribute
            ...
            user_profiles[:num_majority_users, num_attrs-1] = 0 # members of group B
    ...
    if total_creators is not None:
        if dynamic_creators:
            ...
            # more details
            creator_profiles = DynamicCreators(init_items = total_items, size=(total_creators, num_attrs - 1))
        else:
            creator_profiles = Creators(size=(total_creators, num_attrs))
